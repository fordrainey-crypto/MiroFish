          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Chat with any individual in the simulation' }}</span>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick-chat version of the report agent. Has access to 4 research tools and full simulation memory.</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with simulation state using Global/Local Memory to provide cross-temporal attribution analysis.</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">PanoramaSearch — Event Tracker</div>
                    <div class="tool-desc">Graph-based breadth traversal that reconstructs event propagation paths and maps the full topology of information flow.</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG instant query interface for rapidly extracting specific node attributes and discrete facts.</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviewer that runs parallel multi-round conversations with simulated individuals to collect unstructured opinion data.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with the Report Agent to explore the report in depth' : 'Chat with this simulated individual to learn their views' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Enter the question you want to ask all selected individuals…"
                rows="3"
              ></textarea>
            </div>
...
const selectAgent = (agent, idx) => {
  ...
  addLog(`Selected contact: ${agent.username}`)
}
...
const submitSurvey = async () => {
  ...
  addLog(`Sending survey to ${selectedAgents.value.size} individuals…`)
...
const loadProfiles = async () => {
  ...
  try {
    ...
    addLog(`Load simulated individuals failed: ${err.message}`)
  }
}
