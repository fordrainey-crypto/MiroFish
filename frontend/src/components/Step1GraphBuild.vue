    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            The LLM analyzes your documents and simulation question to extract real-world seeds and auto-generate an appropriate ontology structure.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using the generated ontology, documents are chunked and sent to Zep to build a knowledge graph — extracting entities, relationships, temporal memory, and community summaries.
          </p>
