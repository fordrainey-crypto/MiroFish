          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-section">
                ...
                <div class="modal-empty" v-else>No files attached</div>
              </div>
            </div>
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Step 3 (Start Simulation) and Step 5 (Deep Interaction) must be launched live — historical replay is not supported.</span>
            </div>
          </div>
        </div>
      </Transition>
