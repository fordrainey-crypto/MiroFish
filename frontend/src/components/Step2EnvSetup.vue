          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            ...
            <Transition name="fade" mode="out-in">
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="custom-rounds-input">
                  <label class="custom-rounds-label">Number of rounds</label>
                  <input
                    type="number"
                    v-model.number="customMaxRounds"
                    min="1"
                    step="1"
                    class="rounds-number-input"
                  />
                  <p class="rounds-hint">
                    More rounds = more detailed results but higher API cost.
                    <span v-if="autoGeneratedRounds">AI suggested: {{ autoGeneratedRounds }} rounds.</span>
                  </p>
                </div>
              </div>
